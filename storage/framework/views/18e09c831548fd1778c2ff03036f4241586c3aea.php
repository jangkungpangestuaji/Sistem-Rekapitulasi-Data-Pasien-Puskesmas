...
<body>
    <div class="container">
        ...
        <div class="l-right">
            ...
            <div class="row mt-5">
                <div class="col">
                    <a href="<?php echo e(route('kesehatan-jiwa.create')); ?>">
                ...
                <div class="p-4 mt-2">
                    ...
                    <table class="table table-bordered rounded">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="col-1 td1"><?php echo e($value->id); ?></td>
                                <td class="col-1 td1"><?php echo e($value->id_register); ?></td>
                                <td class="col-1 td1"><?php echo e($value->tanggal_lahir); ?></td>
                                <td class="col-1 td1"><?php echo e($value->nama); ?></td>
                                <td class="col-1 td1"><?php echo e($value->diagnosa); ?></td>
                                <td class="col-1 td1"><?php echo e($value->terapi); ?></td>
                                <td class="col-1 td1"><?php echo e($value->pendidikan); ?></td>
                                <td class="col-3 td1"><?php echo e($value->keterangan); ?></td>
                                <td class="col-3">
                                    <form action="<?php echo e(route('kesehatan-jiwa.destroy',$value->id)); ?>" method="POST">
                                        <a href="<?php echo e(route('kesehatan-jiwa.edit', $value->id)); ?>" class="btn">
                                        ...
                                        <a href="<?php echo e(route('kesehatan-jiwa.show', $value->id)); ?>" class="btn">
...
</html><?php /**PATH D:\Semester_6\Kuliah\MPTI\MPTI\mpti_rekapdatapasien\resources\views/partial/kesehatan_jiwa/kesehatan_jiwa.blade.php ENDPATH**/ ?>